...
SRCS = main.cpp Chat.cpp Client.cpp Hash.cpp History.cpp Message.cpp Server.cpp UserInfo.cpp utils.cpp PassCommand.cpp

PATH_SRCS = $(addprefix $(DIR_SRCS)/, $(SRCS))

HEADERS = Chat.hpp Client.hpp Hash.hpp History.hpp Message.hpp Server.hpp UserInfo.hpp utils.hpp PassCommand.hpp
